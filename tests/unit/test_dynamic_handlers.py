...
def test_no_thread_cancel_exception_false_rejected() -> None:
    ...
    # decoration time rather than silently degrading (ARCHITECTURE sync-activity-cancel).
